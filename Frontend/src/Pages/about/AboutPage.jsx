  ...
  const team = [
    {
      ...
      rol: "QA Analyst",
      imageUrl:
        "https://media.licdn.com/dms/image/D4D03AQFOFDOIEkc4pA/profile-displayphoto-shrink_400_400/0/1678317652369?e=1708560000&v=beta&t=kqvVUjXlMA5nebzt2jYH937ORbnS3IrXfz98oVa1Ask",
    ...
    },
    {
      ...
      rol: "Project Manager",
      imageUrl:
        "https://media.licdn.com/dms/image/D5603AQGOXAF0Ua3VHQ/profile-displayphoto-shrink_400_400/0/1701812598819?e=1708560000&v=beta&t=1rWYieINhFpOMR9p87baCK-wrbeHFxxV1Oz02cDbpD8",
    ...
    },
    {
      ...
      imageUrl:
        "https://media.licdn.com/dms/image/D4E03AQF6S-A7AXxLUA/profile-displayphoto-shrink_400_400/0/1698800025568?e=1708560000&v=beta&t=3IR5SQ98ntKPB7tSYc8BVHkaEGEdT3q30jz1lrv77tU",
                  ...
                  <div className='flex flex-col items-center space-y-4 text-center'>
                    <div className='space-y-2'>
                      ...
                      <div className='flex flex-wrap justify-center gap-4 p-3'>
                        {team.map((teammate) => (
                          <OurTeam key={teammate.id} teammate={teammate} />
                        ))}
                      </div>
                    </div>
                  </div>
